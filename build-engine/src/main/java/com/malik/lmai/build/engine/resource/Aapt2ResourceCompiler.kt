package com.malik.lmai.build.engine.resource
...
import com.malik.lmai.build.engine.internal.PackagedBinaryResolver
...
class Aapt2ResourceCompiler(
    context: Context,
) : BuildStep(context, BuildStage.RESOURCE), com.malik.lmai.build.engine.pipeline.ResourceCompiler {
