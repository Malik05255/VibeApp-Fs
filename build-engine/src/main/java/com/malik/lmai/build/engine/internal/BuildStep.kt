package com.malik.lmai.build.engine.internal
...
abstract class BuildStep(
    ...
    suspend fun run(input: com.malik.lmai.build.engine.model.CompileInput): BuildResult {
    ...
    protected abstract suspend fun execute(
        input: com.malik.lmai.build.engine.model.CompileInput,
