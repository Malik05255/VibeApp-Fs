...
internal val TOOL_NAME_RES_IDS: Map<String, Int> = mapOf(
    ...
    "get_design_guide" to R.string.tool_name_get_design_guide,
    "get_project_memo" to R.string.tool_name_get_project_memo,
    "get_ui_pattern" to R.string.tool_name_get_ui_pattern,
    ...
    "search_ui_pattern" to R.string.tool_name_search_ui_pattern,
