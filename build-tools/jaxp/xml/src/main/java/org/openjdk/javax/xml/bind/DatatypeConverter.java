...
final public class DatatypeConverter {
     ...
     */ 
    public static org.openjdk.javax.xml.namespace.QName parseQName( String lexicalXSDQName,
   ...
   public static byte[] parseHexBinary( String lexicalXSDHexBinary ) {
     ...
     */ 
    public static String printQName( org.openjdk.javax.xml.namespace.QName val,
                                     NamespaceContext nsc ) {
        if (theConverter == null) {
            initConverter();
        }
